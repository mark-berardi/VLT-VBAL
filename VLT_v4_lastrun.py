...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\markberardi\\OneDrive - University of Iowa\\Documents\\GitHub\\VLT-VBAL\\VLT_v4_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # Set experiment start values for variable component SpeechTextMid
    SpeechTextMid = ''
    SpeechTextMidContainer = []
        ...
        for thisSpeech_trials_pre in speech_trials_pre:
            ...
            while continueRoutine:
                ...
                if key_resp_SpeechTask.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_SpeechTask.getKeys(keyList=['y','n','left','right','space','backspace'], waitRelease=False)
                ...
                if text_SpeechTask_mid.status == STARTED:
                    # update params
                    text_SpeechTask_mid.setText(SpeechTextMid, log=False)
